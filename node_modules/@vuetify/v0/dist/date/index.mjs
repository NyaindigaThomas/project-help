...
import { n as deriveWeekInfo, t as DateAdapter } from "../adapter-z5dFxm0f.mjs";
	...
	*/
	...
	getMeridiemText(ampm) {
		...
		const match = this.getFormatter({
			hour: "numeric",
			hour12: true
		}).format(date).match(/[ap]m|午前|午後|上午|下午/i);
