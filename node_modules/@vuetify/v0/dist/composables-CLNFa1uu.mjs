import { i as SUPPORTS_MUTATION_OBSERVER, r as SUPPORTS_MATCH_MEDIA, t as IN_BROWSER } from "./globals-DVcr1oW0.mjs";
...
import { i as useContext, t as createTrinity } from "./createTrinity-DJROWgXU.mjs";
...
import { n as useEventListener, r as useWindowEventListener } from "./useEventListener-DI-1-WPJ.mjs";
import { A as createSortable, I as ComboboxAdapter, X as useResizeObserver, Z as createObserver, y as createInput } from "./useRovingFocus-DuYBgzOA.mjs";
import { c as usePrefersReducedMotion, p as useHydration } from "./useTheme-CfrtMZFH.mjs";
import { n as deriveWeekInfo } from "./adapter-z5dFxm0f.mjs";
...
function createBreakpoints(_options = {}) {
	...
	const { mobileBreakpoint, breakpoints } = /* @__PURE__ */ mergeDeep(defaults, options);
...
function createDateContext(_options) {
	...
	const context = createDate(options);
	return createTrinity(namespace, context);
}
/**
